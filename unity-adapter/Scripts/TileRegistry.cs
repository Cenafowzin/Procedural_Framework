...
/// Crie um asset via: Assets → Create → MapGeneration → TileRegistry
///
...
/// Um tipo pode ter ambos (raro, mas possível).
/// </summary>
[CreateAssetMenu(fileName = "TileRegistry", menuName = "MapGeneration/TileRegistry")]
public class TileRegistry : ScriptableObject
{
    ...
    /// Retorna uma variante aleatória para o tipo, ou null se não mapeado.
